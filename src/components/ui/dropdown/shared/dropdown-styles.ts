export const DROPDOWN_STYLES = {
  ...
  itemBase: "relative flex w-full cursor-pointer select-none items-center py-[8px] px-[12px] text-[14px] text-neutral-6 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50"
} as const;
